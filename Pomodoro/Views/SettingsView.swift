...
struct SettingsView: View {
    ...
    @State var curSounds = [true, false, false, false, false, false, false, false]
    @Binding var visibility: Bool
    @Binding var travelToPomoTimer: Bool
    @Binding var travelToPauseTimer: Bool
    var body: some View {
            ScrollView {
                        ...
                        HStack(alignment: .top, spacing: 16) {
                            ForEach(0..<timers.count) { index in
                                Button {
                                    ...
                                    if(index == 0) {
                                        travelToPomoTimer = true
                                    } else {
                                        travelToPauseTimer = true
                                    }
